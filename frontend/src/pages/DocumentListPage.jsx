...
export default function DocumentListPage() {
  ...
  useEffect(() => {
    ...
    function handleClickOutside(event) {
      // Always check if the click was outside the popover and button
      if (
    ...
    // Add event listener with a small delay to avoid closing immediately
            ...
            <div className="relative min-w-[255px] flex-1">
              ...
              {dateRangePopoverOpen && (
                <div
                  ...
                  className="absolute z-50 mt-2 right-0.5 -left-5 hite border border-gray-200 rounded-lg shadow-lg"
                ...
                >
                  <DateRangePicker
                    ...
                    onRangeSelected={(range) => {
                      ...
                      // Update filters immediately when range is selected
                      setFilters((prev) => ({
                        ...prev,
                        created_date_from: range.start?.toISOString().slice(0, 10) || '',
                        created_date_to: range.end?.toISOString().slice(0, 10) || '',
                      }));
                      // If range is cleared (both start and end are null), close the picker
